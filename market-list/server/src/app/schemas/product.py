...
class ProdutoUpdateSchema(BaseModel):
    """Payload para atualização de produtos.

    - "nome" identifica o produto atual (chave atual)
    - os demais campos são opcionais e, quando informados, serão atualizados
    - para renomear, utilize "novo_nome"
    """
